 ...
 *
 * Modified by Ian Melnick for compatibility with Java 1.5, and convinience...
 */
...
/*	private String readLine(int firstChar) throws IOException {
	 ...
	 * @param dataInput the input stream to read from
	 */
	public void ImageInfo(DataInput dataInput) {
		this.setInput(dataInput);
	}
	 ...
	 * @param inputStream the input stream to read from
	 */
	public void ImageInfo(InputStream inputStream) {
